...
def json_to_html(data):
    ...
    def process_company(company):
        html_output.append('<div style="border:1px solid gray; padding:20px;">')
    ...
    def process_employee(employee):
        ...
        html_output.append(f'<li>{employee["nombre"]}</li>')

        if "proyectos" in employee:
            html_output.append('<table><tr><th>Nombre</th><th>Estado</th><th>Fecha Inicio</th><th>Fecha Fin</th></tr>')
